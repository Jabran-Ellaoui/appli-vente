...
public class SearchCustomerPanel extends JPanel {
    ...
    public SearchCustomerPanel(SearchController searchController, MainWindow mainWindow)
    {
        ...
        JPanel infoPanel = new JPanel(new GridLayout(7, 1)); // 2 lignes : client + employé
        ...
        searchButton.addActionListener(e ->
        {
            try {
                ...
                DefaultTableModel model = new DefaultTableModel(new String[]{"Produit", "Prix", "Promotion appliquée (en %)"}, 0);
